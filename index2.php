...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="pages/editcutomer.php" class="d-block"><?php echo $objResult["Username"];?></a>
  ...
  <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="pages/productlinecustomer.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="pages/cartcustomer.php" class="nav-link">
