          ...
          <div class="col-12">
            ...
            <div class="card-body">
                ...
                <?php
                    ...
                    $query2 = "select * from product JOIN productcategory ON product.ProductCategoryID =  productcategory.productCategoryID WHERE ProductID = '$Product_sub' ";                       
            ...
            <div class="card-body">
                ...
                <div class="col-12 col-sm-6">
                  ...
                  <small style="color: black;"><?php echo $objResult3["Scale"]; ?>% | <?php echo $objResult3["cName"]; ?></small>
                  ...
                  <br>
                        ...
                        <form action="addtocart.php"  method="POST">
                                <div class="col-sm-3">
                                  ...
                                  <p>Qty : </p>&nbsp&nbsp <input type="number" class="form-control" id="qty" step="1" min="1" max="7724" name="Quantity" value="1">  
                               ...
                               <!--เปลี่ยน-->
                                ...
                                <div class="offset col-sm-3">
                                       ...
                                       <!-- <input type="text" name="user" value="<?php $objResult["EmployeeNumber"]?>" hidden> -->
                                      </div>
                                </div>
                             <!--llllll-->
                            </form>       
