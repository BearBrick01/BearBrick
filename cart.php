...
// $user=$_POST['user'];
$query3 = "select * from (ordersummary JOIN product ON ordersummary.ProductID = product.ProductID ) JOIN employees ON employees.EmployeeNumber = ordersummary.user and ordersummary.User_or = employees.Username WHERE employees.EmployeeNumber='".$_SESSION['EmployeeNumber']."' ";
...
//**DISPLAY order INFO */
// $query3 = "select * from ((ordersummary JOIN product ON ordersummary.ProductID = product.ProductID ) JOIN employees ON employees.EmployeeNumber = ordersummary.user and ordersummary.User_or = employees.Username and  EmployeeNumber = '".$_SESSION['EmployeeNumber']."')"; 
// $result3 = mysqli_query($conn, $query3);
// $objResult3 = mysqli_fetch_array($result3); 
//**DISPLAY order INFO */
// $query3 = "select * from ((ordersummary JOIN product ON ordersummary.ProductID = product.ProductID ) JOIN employees ON employees.EmployeeNumber = ordersummary.user and ordersummary.User_or = employees.Username WHERE EmployeeNumber = '".$_SESSION['EmployeeNumber']."' )";                   
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                    ...
                    Email: <?php echo $objResult['Email']?>
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-3 invoice-col">
                  ...
                  <br> -->
                  <!-- <b>Order ID:&nbsp;&nbsp;</b><?php echo $objResult['OrderID']?><br> -->
                             ...
                             while($objResult = mysqli_fetch_array($result3)){
                              ...
                              <tbody style="text-align: center;">
                                <tr>
                                    ...
                                    <?php $AllTotal = $AllTotal+ $SubTotal;  // echo $AllTotal; ?> 
                                </tr>
              ...
              <table class="table">
                <tbody>
                  <!-- <tr>
                    ...
                    <td name="pricequantity"> <?php echo $objResult['SubTotal']?></td>
                  </tr> -->
                  <tr>
                    <th>Shipping:</th>
                    <td>Free</td>
