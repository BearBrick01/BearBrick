...
$qry = "DELETE FROM customer WHERE CustomerNumber = '$deleteid' ";
...
<head>
  ...
  <title>Bearbrick | Customer</title>
  <!-- Bootstrap CSS -->
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class ="customeradd" style="display:inline-block;float:right ">
                <a href="customeradd.php"><i class="fa fa-user-plus"  aria-hidden="true"></i> Add</a>
                </div>
  ...
  <tbody>
    ...
    // $deleteid = $objResult2['CustomerNumber'];
    ?>
  
    <tr>
      <th scope="row"><?php echo $objResult2['CustomerNumber'] ?></th>
      <!-- <td><?php echo $objResult2['ModifiedDate'] ?></td> -->
      <td><?php echo $objResult2['FirstName'] ?></td>
      <td><?php echo $objResult2['LastName'] ?></td>
      <td><?php echo $objResult2['EmailAddress'] ?></td>
      <td><?php echo $objResult2['Phone'] ?></td>
      ...
      <button type="submit" name="delete" class="btn btn-danger btn-sm"value="<?php echo $objResult2['CustomerNumber'] ?>"> REMOVE </button>
