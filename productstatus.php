...
if (isset($_POST['delete'])) {
  ...
  $qry = "DELETE FROM product WHERE ProductID= '$deleteid' ";
             ...
             <thead>
                ...
                <?php 
                  ...
                  while($objResult2 = mysqli_fetch_array($result2)){
                    $deleteid =$objResult2['ProductID'];
                  ?>
                            <tr>
                            <th scope="row"><a class="underline" href="product-details.php?id=S10_1678"><?php echo $objResult2['ProductID']?></a></th>
                            <td><?php echo $objResult2['Name']?></td>
                            <td><?php echo $objResult2['Quantity']?></td>
                            <td>Branch : <?php echo $objResult2['OfficeCode']?></td>
                            <td width="250">
                            <form method="post">
                                    <a href="transfer.php" class="btn btn-outline-warning btn-sm "> Stock </a> 
                                    <a href="Update.php" class="btn btn-outline-success btn-sm "> Update </a>
                                   
                                    <button type="submit" name="delete" class="btn btn-outline-danger btn-sm"value="<?php echo $objResult2['ProductID'] ?>"> REMOVE </button>
